...
function source_if_file_exists() {
	[ -f $1 ] && source $1
}

# NodeJS CA Certs
add_env_variable_if_file_exists "NODE_EXTRA_CA_CERTS" "/etc/ssl/certs/ca-certifificates.crt"

# NodeJS OpenSSL config
add_env_variable_if_file_exists "OPENSSL_CONF" "$HOME/.openssl-node.cnf"

# Rust sourcing
source_if_file_exists "$HOME/.cargo/env"
